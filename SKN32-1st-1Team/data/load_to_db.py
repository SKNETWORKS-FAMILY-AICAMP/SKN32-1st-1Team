...
DB_CONFIG = {
    ...
    "port": int(os.getenv("DB_PORT")),  # 포트는 정수형 변환이 필요합니다
            ...
            rows.append(
                {
                    ...
                    "region": r,
                    "car_type": ct,
                    "cnt_official": safe_int(cols[0]),
                    "cnt_private": safe_int(cols[1]),
                    "cnt_business": safe_int(cols[2]),
                    "cnt_total": safe_int(cols[3]),
                }
            )
    return rows
